...
from coapair import CoAPAirClient

# map files location
options_map_file=f'{sys.path[0]}/maps/options.map'
values_map_file=f'{sys.path[0]}/maps/values.map'
...
class airclient():
  def __init__(self,host):
    ...
    for line in open(options_map_file):
      ...
      self.options_map['out']['requirement'][mapped] = valreq # it's only for out
